...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFD1GTQqBM2KpOpET6/326uSTsXEuV/A2aJvI5pqLL/Ya5wvhbZNN
::YB416Ek+ZG8=
::
::
...
REM Arch Neovim
wt new-tab -p "{ea073364-181a-4f41-b61d-dbf1a46efe4a}" --startingDirectory "%FILE_DIR%" nvim "%FILE_PATH%"