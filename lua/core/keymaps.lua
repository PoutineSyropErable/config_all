...
vim.api.nvim_set_keymap('n', '<Leader>e', ':w<CR>:lua ExecuteFile()<CR>', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('v', '<leader>u', '<C-a>', { noremap = true, silent = true })
...
vim.keymap.set('', "<C-s>j",     ":wincmd h<CR>")
vim.keymap.set('', "<C-s>i",     ":wincmd k<CR>")
vim.keymap.set('', "<C-s>k",     ":wincmd j<CR>")
vim.keymap.set('', "<C-s>l",     ":wincmd l<CR>")

vim.keymap.set('', "<C-s><Left>",   ":wincmd h<CR>")
vim.keymap.set('', "<C-s><Up>",     ":wincmd k<CR>")
vim.keymap.set('', "<C-s><Down>",   ":wincmd j<CR>")
vim.keymap.set('', "<C-s><Right>",  ":wincmd l<CR>")

vim.keymap.set('', "<C-s>,", 	 ":wincmd <CR>")
vim.keymap.set('', "<C-s>Space", ":wincmd <CR>")
...
vim.keymap.set("n", "<leader><BS>", require("oil").open, { desc = "Open parent directory" })
