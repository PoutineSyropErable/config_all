...
vim.keymap.set('n', '<leader>sh',   tapi.node.open.horizontal,            opts('Open: Horizontal Split'))




-- Create a custom key mapping to focus the view on the currently selected directory
vim.api.nvim_set_keymap('n', '<leader>e', ':lua require("nvim-tree.api").tree.focus()<CR>',
...
vim.keymap.set('n', '<leader>fH', ':nohlsearch<CR>')
...
vim.api.nvim_set_keymap('n', '<leader>hl', ':lua require("harpoon.ui").toggle_quick_menu()<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>hj', ':lua require("harpoon.ui").nav_file(1)<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>hk', ':lua require("harpoon.ui").nav_file(2)<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>hl', ':lua require("harpoon.ui").nav_file(3)<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>hm', ':lua require("harpoon.ui").nav_file(4)<CR>', { noremap = true, silent = true })
...
-- In vscode, Control c doesn't seem to work. So, here's hoping it does
vim.api.nvim_set_keymap('v', '<C-c>', '"+y', { noremap = true, silent = true })
vim.api.nvim_set_keymap('t', '<C-c>', '"+y', { noremap = true, silent = true })
vim.api.nvim_set_keymap('', '<C-x>', '"+d', { noremap = true, silent = true })
vim.api.nvim_set_keymap('', '<C-V>', '"+p', { noremap = true, silent = true })
-- Bind Backspace to 'd' in visual mode
vim.api.nvim_set_keymap('v', '<BS>', '"_d', { noremap = true, silent = true })
